...
pub type TMEIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, TMEIE_A>;
...
pub type FMPIE0_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FMPIE0_A>;
...
pub type FFIE0_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FFIE0_A>;
...
pub type FOVIE0_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FOVIE0_A>;
...
pub type FMPIE1_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FMPIE1_A>;
...
pub type FFIE1_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FFIE1_A>;
...
pub type FOVIE1_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, FOVIE1_A>;
...
pub type EWGIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EWGIE_A>;
...
pub type EPVIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EPVIE_A>;
...
pub type BOFIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, BOFIE_A>;
...
pub type LECIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, LECIE_A>;
...
pub type ERRIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, ERRIE_A>;
...
pub type WKUIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, WKUIE_A>;
...
pub type SLKIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, SLKIE_A>;
