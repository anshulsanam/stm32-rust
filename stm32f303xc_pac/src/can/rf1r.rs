...
pub type FULL1_W<'a, const O: u8> = crate::BitWriter<'a, RF1R_SPEC, O>;
#[doc = "Field `FOVR1` reader - FOVR1"]
pub type FOVR1_R = crate::BitReader;
#[doc = "Field `FOVR1` writer - FOVR1"]
pub type FOVR1_W<'a, const O: u8> = crate::BitWriter<'a, RF1R_SPEC, O>;
#[doc = "Field `RFOM1` reader - RFOM1"]
pub type RFOM1_R = crate::BitReader;
#[doc = "Field `RFOM1` writer - RFOM1"]
pub type RFOM1_W<'a, const O: u8> = crate::BitWriter<'a, RF1R_SPEC, O>;
impl R {
    #[doc = "Bits 0:1 - FMP1"]
    #[inline(always)]
