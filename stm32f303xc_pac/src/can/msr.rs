...
pub type ERRI_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O>;
#[doc = "Field `WKUI` reader - WKUI"]
pub type WKUI_R = crate::BitReader;
#[doc = "Field `WKUI` writer - WKUI"]
pub type WKUI_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O>;
#[doc = "Field `SLAKI` reader - SLAKI"]
pub type SLAKI_R = crate::BitReader;
#[doc = "Field `SLAKI` writer - SLAKI"]
pub type SLAKI_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O>;
