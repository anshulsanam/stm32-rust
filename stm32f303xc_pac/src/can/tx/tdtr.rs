...
pub type DLC_W<'a, const O: u8> = crate::FieldWriter<'a, TDTR_SPEC, 4, O>;
#[doc = "Field `TGT` reader - TGT"]
pub type TGT_R = crate::BitReader;
#[doc = "Field `TGT` writer - TGT"]
pub type TGT_W<'a, const O: u8> = crate::BitWriter<'a, TDTR_SPEC, O>;
#[doc = "Field `TIME` reader - TIME"]
pub type TIME_R = crate::FieldReader<u16>;
#[doc = "Field `TIME` writer - TIME"]
pub type TIME_W<'a, const O: u8> = crate::FieldWriter<'a, TDTR_SPEC, 16, O, u16>;
impl R {
    #[doc = "Bits 0:3 - DLC"]
    #[inline(always)]
