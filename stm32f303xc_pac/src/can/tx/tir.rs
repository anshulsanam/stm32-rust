...
pub type TXRQ_W<'a, const O: u8> = crate::BitWriter<'a, TIR_SPEC, O>;
...
pub type RTR_W<'a, const O: u8> = crate::BitWriter<'a, TIR_SPEC, O, RTR_A>;
...
pub type IDE_W<'a, const O: u8> = crate::BitWriter<'a, TIR_SPEC, O, IDE_A>;
...
pub type EXID_W<'a, const O: u8> = crate::FieldWriter<'a, TIR_SPEC, 18, O, u32>;
#[doc = "Field `STID` reader - STID"]
pub type STID_R = crate::FieldReader<u16>;
#[doc = "Field `STID` writer - STID"]
pub type STID_W<'a, const O: u8> = crate::FieldWriter<'a, TIR_SPEC, 11, O, u16>;
impl R {
    #[doc = "Bit 0 - TXRQ"]
    #[inline(always)]
