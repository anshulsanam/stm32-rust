...
impl LSIRDYF_R {
    ...
    pub fn variant(&self) -> LSIRDYFR_A {
        match self.bits {
            false => LSIRDYFR_A::NOT_INTERRUPTED,
            true => LSIRDYFR_A::INTERRUPTED,
        }
    }
    #[doc = "Checks if the value of the field is `NOT_INTERRUPTED`"]
    #[inline(always)]
    pub fn is_not_interrupted(&self) -> bool {
        *self == LSIRDYFR_A::NOT_INTERRUPTED
    }
...
pub type LSIRDYIE_W<'a, const O: u8> = crate::BitWriter<'a, CIR_SPEC, O, LSIRDYIE_A>;
...
pub type LSIRDYC_W<'a, const O: u8> = crate::BitWriter<'a, CIR_SPEC, O, LSIRDYCW_AW>;
...
pub type CSSC_W<'a, const O: u8> = crate::BitWriter<'a, CIR_SPEC, O, CSSCW_AW>;
