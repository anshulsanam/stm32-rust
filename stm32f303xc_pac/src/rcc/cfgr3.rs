...
pub type USART1SW_R = crate::FieldReader<USART1SW_A>;
...
impl crate::FieldSpec for USART1SW_A {
    type Ux = u8;
}
impl USART1SW_R {
...
pub type USART1SW_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CFGR3_SPEC, 2, O, USART1SW_A>;
...
pub type I2C1SW_W<'a, const O: u8> = crate::BitWriter<'a, CFGR3_SPEC, O, I2C1SW_A>;
...
pub type TIM1SW_W<'a, const O: u8> = crate::BitWriter<'a, CFGR3_SPEC, O, TIM1SW_A>;
