...
pub type PREDIV_R = crate::FieldReader<PREDIV_A>;
...
impl crate::FieldSpec for PREDIV_A {
    type Ux = u8;
}
impl PREDIV_R {
...
pub type PREDIV_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CFGR2_SPEC, 4, O, PREDIV_A>;
...
pub type ADC12PRES_R = crate::FieldReader<ADC12PRES_A>;
...
impl crate::FieldSpec for ADC12PRES_A {
    type Ux = u8;
}
impl ADC12PRES_R {
    #[doc = "Get enumerated values variant"]
...
pub type ADC12PRES_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR2_SPEC, 5, O, ADC12PRES_A>;
impl<'a, const O: u8> ADC12PRES_W<'a, O> {
    #[doc = "No clock"]
    #[inline(always)]
    pub fn no_clock(self) -> &'a mut W {
        self.variant(ADC12PRES_A::NO_CLOCK)
    }
