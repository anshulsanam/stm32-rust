...
pub type LSION_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, LSION_A>;
...
pub type V18PWRRSTF_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, V18PWRRSTFR_A>;
impl<'a, const O: u8> V18PWRRSTF_W<'a, O> {
    #[doc = "No reset has occured"]
    #[inline(always)]
    pub fn no_reset(self) -> &'a mut W {
        self.variant(V18PWRRSTFR_A::NO_RESET)
    }
...
pub type RMVF_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, RMVFW_A>;
