...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O, DIR_A>;
...
impl CMS_R {
    ...
    pub fn variant(&self) -> CMS_A {
        match self.bits {
            0 => CMS_A::EDGE_ALIGNED,
            1 => CMS_A::CENTER_ALIGNED1,
            2 => CMS_A::CENTER_ALIGNED2,
            3 => CMS_A::CENTER_ALIGNED3,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_edge_aligned(&self) -> bool {
        *self == CMS_A::EDGE_ALIGNED
    }
    #[doc = "Checks if the value of the field is `CENTER_ALIGNED1`"]
    #[inline(always)]
    pub fn is_center_aligned1(&self) -> bool {
        *self == CMS_A::CENTER_ALIGNED1
    }
    #[doc = "Checks if the value of the field is `CENTER_ALIGNED2`"]
    #[inline(always)]
    pub fn is_center_aligned2(&self) -> bool {
        *self == CMS_A::CENTER_ALIGNED2
    }
    #[doc = "Checks if the value of the field is `CENTER_ALIGNED3`"]
    #[inline(always)]
    pub fn is_center_aligned3(&self) -> bool {
        *self == CMS_A::CENTER_ALIGNED3
    }
}
#[doc = "Field `CMS` writer - Center-aligned mode selection"]
pub type CMS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CR1_SPEC, 2, O, CMS_A>;
impl<'a, const O: u8> CMS_W<'a, O> {
    ...
    pub fn edge_aligned(self) -> &'a mut W {
        self.variant(CMS_A::EDGE_ALIGNED)
    }
    ...
    pub fn center_aligned1(self) -> &'a mut W {
        self.variant(CMS_A::CENTER_ALIGNED1)
    }
    ...
    pub fn center_aligned2(self) -> &'a mut W {
        self.variant(CMS_A::CENTER_ALIGNED2)
    }
    ...
    pub fn center_aligned3(self) -> &'a mut W {
        self.variant(CMS_A::CENTER_ALIGNED3)
    }
}
