...
pub type CC1S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_OUTPUT_SPEC, 2, O, CC1S_A>;
...
pub type OC1PE_W<'a, const O: u8> = crate::BitWriter<'a, CCMR1_OUTPUT_SPEC, O, OC1PE_A>;
...
pub type CC2S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_OUTPUT_SPEC, 2, O, CC2S_A>;
...
pub type OC2PE_W<'a, const O: u8> = crate::BitWriter<'a, CCMR1_OUTPUT_SPEC, O, OC2PE_A>;
