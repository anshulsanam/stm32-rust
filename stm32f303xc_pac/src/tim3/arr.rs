...
pub type ARR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ARR_SPEC, 16, O, u16>;
#[doc = "Field `ARRH` reader - High Auto-reload value"]
pub type ARRH_R = crate::FieldReader<u16>;
#[doc = "Field `ARRH` writer - High Auto-reload value"]
pub type ARRH_W<'a, const O: u8> = crate::FieldWriter<'a, ARR_SPEC, 16, O, u16>;
impl R {
