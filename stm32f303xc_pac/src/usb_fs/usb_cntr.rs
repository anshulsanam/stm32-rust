...
pub type ESOFM_W<'a, const O: u8> = crate::BitWriter<'a, USB_CNTR_SPEC, O>;
...
pub type SOFM_W<'a, const O: u8> = crate::BitWriter<'a, USB_CNTR_SPEC, O>;
...
pub type RESETM_W<'a, const O: u8> = crate::BitWriter<'a, USB_CNTR_SPEC, O>;
...
pub type PMAOVRM_W<'a, const O: u8> = crate::BitWriter<'a, USB_CNTR_SPEC, O>;
...
pub type CTRM_W<'a, const O: u8> = crate::BitWriter<'a, USB_CNTR_SPEC, O>;
impl R {
