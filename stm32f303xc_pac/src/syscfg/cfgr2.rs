...
pub type LOCKUP_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, CFGR2_SPEC, O, LOCKUP_LOCK_A>;
...
pub type SRAM_PARITY_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, CFGR2_SPEC, O, SRAM_PARITY_LOCK_A>;
...
pub type PVD_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, CFGR2_SPEC, O, PVD_LOCK_A>;
...
impl BYP_ADDR_PAR_R {
    ...
    pub fn variant(&self) -> BYP_ADDR_PAR_A {
        match self.bits {
            false => BYP_ADDR_PAR_A::NO_BYPASS,
...
pub type BYP_ADDR_PAR_W<'a, const O: u8> = crate::BitWriter<'a, CFGR2_SPEC, O, BYP_ADDR_PAR_A>;
impl<'a, const O: u8> BYP_ADDR_PAR_W<'a, O> {
    ...
    pub fn no_bypass(self) -> &'a mut W {
        self.variant(BYP_ADDR_PAR_A::NO_BYPASS)
    }
...
impl SRAM_PEF_R {
    ...
    pub fn variant(&self) -> SRAM_PEFR_A {
        match self.bits {
            false => SRAM_PEFR_A::NO_PARITY_ERROR,
            true => SRAM_PEFR_A::PARITY_ERROR_DETECTED,
        }
    }
    #[doc = "Checks if the value of the field is `NO_PARITY_ERROR`"]
    #[inline(always)]
    pub fn is_no_parity_error(&self) -> bool {
        *self == SRAM_PEFR_A::NO_PARITY_ERROR
    }
    #[doc = "Checks if the value of the field is `PARITY_ERROR_DETECTED`"]
    #[inline(always)]
    pub fn is_parity_error_detected(&self) -> bool {
        *self == SRAM_PEFR_A::PARITY_ERROR_DETECTED
    }
}
#[doc = "SRAM parity flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type SRAM_PEF_W<'a, const O: u8> = crate::BitWriter<'a, CFGR2_SPEC, O, SRAM_PEFW_AW>;
