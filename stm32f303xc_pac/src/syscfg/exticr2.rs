...
pub type EXTI4_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O, EXTI4_A>;
...
pub type EXTI5_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O, EXTI5_A>;
...
pub type EXTI6_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O, EXTI6_A>;
...
pub type EXTI7_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O, EXTI7_A>;
