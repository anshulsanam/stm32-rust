...
pub type EA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EP2R_SPEC, 4, O>;
...
pub type STAT_TX_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EP2R_SPEC, 2, O, STAT_TX_A>;
...
pub type EP_TYPE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EP2R_SPEC, 2, O, EP_TYPE_A>;
...
pub type STAT_RX_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EP2R_SPEC, 2, O, STAT_RX_A>;
