...
pub type CGIF1_W<'a, const O: u8> = crate::BitWriter<'a, IFCR_SPEC, O, CGIF1_AW>;
...
pub type CTCIF1_W<'a, const O: u8> = crate::BitWriter<'a, IFCR_SPEC, O, CTCIF1_AW>;
...
pub type CHTIF1_W<'a, const O: u8> = crate::BitWriter<'a, IFCR_SPEC, O, CHTIF1_AW>;
...
pub type CTEIF1_W<'a, const O: u8> = crate::BitWriter<'a, IFCR_SPEC, O, CTEIF1_AW>;
