...
pub type PECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, PECF_A>;
...
pub type FECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, FECF_A>;
...
pub type NCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, NCF_A>;
...
pub type ORECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, ORECF_A>;
...
pub type IDLECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, IDLECF_A>;
...
pub type TCCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, TCCF_A>;
...
pub type LBDCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, LBDCF_A>;
...
pub type CTSCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, CTSCF_A>;
...
pub type RTOCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, RTOCF_A>;
...
pub type EOBCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, EOBCF_A>;
...
pub type CMCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, CMCF_A>;
...
pub type WUCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O, WUCF_A>;
