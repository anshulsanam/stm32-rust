...
pub type ABRRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O, ABRRQ_A>;
...
pub type SBKRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O, SBKRQ_A>;
...
pub type MMRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O, MMRQ_A>;
...
pub type RXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O, RXFRQ_A>;
...
pub type TXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O, TXFRQ_A>;
