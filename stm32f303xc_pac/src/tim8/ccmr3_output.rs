...
pub type OC5M_R = crate::FieldReader<OC5M_A>;
...
impl crate::FieldSpec for OC5M_A {
    type Ux = u8;
}
impl OC5M_R {
    ...
    pub fn variant(&self) -> OC5M_A {
        match self.bits {
            0 => OC5M_A::FROZEN,
            1 => OC5M_A::ACTIVE_ON_MATCH,
            2 => OC5M_A::INACTIVE_ON_MATCH,
            3 => OC5M_A::TOGGLE,
            4 => OC5M_A::FORCE_INACTIVE,
            5 => OC5M_A::FORCE_ACTIVE,
            6 => OC5M_A::PWM_MODE1,
            7 => OC5M_A::PWM_MODE2,
            _ => unreachable!(),
        }
...
impl<'a, const O: u8> OC5M_W<'a, O> {
    ...
    pub fn active_on_match(self) -> &'a mut W {
        self.variant(OC5M_A::ACTIVE_ON_MATCH)
    }
    ...
    pub fn inactive_on_match(self) -> &'a mut W {
        self.variant(OC5M_A::INACTIVE_ON_MATCH)
    }
    ...
    pub fn force_inactive(self) -> &'a mut W {
        self.variant(OC5M_A::FORCE_INACTIVE)
    }
    ...
    pub fn force_active(self) -> &'a mut W {
        self.variant(OC5M_A::FORCE_ACTIVE)
    }
...
pub type OC5M_3_W<'a, const O: u8> = crate::BitWriter<'a, CCMR3_OUTPUT_SPEC, O, OC5M_3_A>;
