...
impl ALRAWF_R {
    ...
    pub fn variant(&self) -> ALRAWFR_A {
        match self.bits {
            false => ALRAWFR_A::UPDATE_NOT_ALLOWED,
            true => ALRAWFR_A::UPDATE_ALLOWED,
        }
    }
    #[doc = "Checks if the value of the field is `UPDATE_NOT_ALLOWED`"]
    #[inline(always)]
    pub fn is_update_not_allowed(&self) -> bool {
        *self == ALRAWFR_A::UPDATE_NOT_ALLOWED
    }
    #[doc = "Checks if the value of the field is `UPDATE_ALLOWED`"]
    #[inline(always)]
    pub fn is_update_allowed(&self) -> bool {
        *self == ALRAWFR_A::UPDATE_ALLOWED
    }
}
...
impl WUTWF_R {
    ...
    pub fn variant(&self) -> WUTWFR_A {
        match self.bits {
            false => WUTWFR_A::UPDATE_NOT_ALLOWED,
            true => WUTWFR_A::UPDATE_ALLOWED,
        }
    }
    #[doc = "Checks if the value of the field is `UPDATE_NOT_ALLOWED`"]
    #[inline(always)]
    pub fn is_update_not_allowed(&self) -> bool {
        *self == WUTWFR_A::UPDATE_NOT_ALLOWED
    }
    #[doc = "Checks if the value of the field is `UPDATE_ALLOWED`"]
    #[inline(always)]
    pub fn is_update_allowed(&self) -> bool {
        *self == WUTWFR_A::UPDATE_ALLOWED
    }
}
...
impl SHPF_R {
    ...
    pub fn variant(&self) -> SHPFR_A {
        match self.bits {
            false => SHPFR_A::NO_SHIFT_PENDING,
            true => SHPFR_A::SHIFT_PENDING,
        }
    }
    #[doc = "Checks if the value of the field is `NO_SHIFT_PENDING`"]
    #[inline(always)]
    pub fn is_no_shift_pending(&self) -> bool {
        *self == SHPFR_A::NO_SHIFT_PENDING
    }
    #[doc = "Checks if the value of the field is `SHIFT_PENDING`"]
    #[inline(always)]
    pub fn is_shift_pending(&self) -> bool {
        *self == SHPFR_A::SHIFT_PENDING
    }
}
#[doc = "Field `SHPF` writer - Shift operation pending"]
pub type SHPF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, SHPFR_A>;
impl<'a, const O: u8> SHPF_W<'a, O> {
    #[doc = "No shift operation is pending"]
    #[inline(always)]
    pub fn no_shift_pending(self) -> &'a mut W {
        self.variant(SHPFR_A::NO_SHIFT_PENDING)
    }
    #[doc = "A shift operation is pending"]
    #[inline(always)]
    pub fn shift_pending(self) -> &'a mut W {
        self.variant(SHPFR_A::SHIFT_PENDING)
    }
}
...
impl INITS_R {
    ...
    pub fn variant(&self) -> INITSR_A {
        match self.bits {
            false => INITSR_A::NOT_INITALIZED,
            true => INITSR_A::INITALIZED,
        }
    }
    #[doc = "Checks if the value of the field is `NOT_INITALIZED`"]
    #[inline(always)]
    pub fn is_not_initalized(&self) -> bool {
        *self == INITSR_A::NOT_INITALIZED
    }
...
impl RSF_R {
    ...
    pub fn variant(&self) -> RSFR_A {
        match self.bits {
            false => RSFR_A::NOT_SYNCED,
            true => RSFR_A::SYNCED,
        }
    }
    #[doc = "Checks if the value of the field is `NOT_SYNCED`"]
    #[inline(always)]
    pub fn is_not_synced(&self) -> bool {
        *self == RSFR_A::NOT_SYNCED
    }
...
pub type RSF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, RSFW_AW>;
...
impl INIT_R {
    ...
    pub fn variant(&self) -> INIT_A {
        match self.bits {
            false => INIT_A::FREE_RUNNING_MODE,
            true => INIT_A::INIT_MODE,
        }
    }
    #[doc = "Checks if the value of the field is `FREE_RUNNING_MODE`"]
    #[inline(always)]
    pub fn is_free_running_mode(&self) -> bool {
        *self == INIT_A::FREE_RUNNING_MODE
    }
    #[doc = "Checks if the value of the field is `INIT_MODE`"]
    #[inline(always)]
    pub fn is_init_mode(&self) -> bool {
        *self == INIT_A::INIT_MODE
    }
}
#[doc = "Field `INIT` writer - Initialization mode"]
pub type INIT_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, INIT_A>;
impl<'a, const O: u8> INIT_W<'a, O> {
    #[doc = "Free running mode"]
    #[inline(always)]
    pub fn free_running_mode(self) -> &'a mut W {
        self.variant(INIT_A::FREE_RUNNING_MODE)
    }
...
pub type ALRAF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, ALRAFW_AW>;
...
pub type ALRBF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, ALRBFW_AW>;
...
pub type WUTF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, WUTFW_AW>;
...
impl TSF_R {
    ...
    pub fn variant(&self) -> Option<TSFR_A> {
        match self.bits {
            true => Some(TSFR_A::TIMESTAMP_EVENT),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIMESTAMP_EVENT`"]
    #[inline(always)]
    pub fn is_timestamp_event(&self) -> bool {
        *self == TSFR_A::TIMESTAMP_EVENT
    }
}
#[doc = "Time-stamp flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type TSF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, TSFW_AW>;
...
pub type TSOVF_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, TSOVFW_AW>;
...
pub type TAMP1F_W<'a, const O: u8> = crate::BitWriter<'a, ISR_SPEC, O, TAMP1FW_AW>;
