...
pub type LPDS_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type PDDS_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O, PDDS_A>;
...
pub type CWUF_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `CSBF` reader - Clear standby flag"]
pub type CSBF_R = crate::BitReader;
#[doc = "Field `CSBF` writer - Clear standby flag"]
pub type CSBF_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type PVDE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `PLS` reader - PVD level selection"]
pub type PLS_R = crate::FieldReader;
#[doc = "Field `PLS` writer - PVD level selection"]
pub type PLS_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 3, O>;
...
pub type DBP_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
impl R {
