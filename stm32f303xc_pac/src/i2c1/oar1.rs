...
pub type OA1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, OAR1_SPEC, 10, O, u16>;
...
pub type OA1MODE_W<'a, const O: u8> = crate::BitWriter<'a, OAR1_SPEC, O, OA1MODE_A>;
...
pub type OA1EN_W<'a, const O: u8> = crate::BitWriter<'a, OAR1_SPEC, O, OA1EN_A>;
