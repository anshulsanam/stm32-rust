...
pub type OA2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, OAR2_SPEC, 7, O>;
...
pub type OA2MSK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, OAR2_SPEC, 3, O, OA2MSK_A>;
impl<'a, const O: u8> OA2MSK_W<'a, O> {
    #[doc = "No mask"]
    #[inline(always)]
    pub fn no_mask(self) -> &'a mut W {
        self.variant(OA2MSK_A::NO_MASK)
    }
    #[doc = "OA2\\[1\\]
is masked and don’t care. Only OA2\\[7:2\\]
are compared"]
...
pub type OA2EN_W<'a, const O: u8> = crate::BitWriter<'a, OAR2_SPEC, O, OA2EN_A>;
