...
pub type TIMEOUTA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TIMEOUTR_SPEC, 12, O, u16>;
...
pub type TIDLE_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O, TIDLE_A>;
...
pub type TIMOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O, TIMOUTEN_A>;
...
pub type TIMEOUTB_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TIMEOUTR_SPEC, 12, O, u16>;
...
pub type TEXTEN_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O, TEXTEN_A>;
