...
impl OPTERR_R {
    ...
    pub fn variant(&self) -> Option<OPTERR_A> {
        match self.bits {
            true => Some(OPTERR_A::OPTION_BYTE_ERROR),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `OPTION_BYTE_ERROR`"]
    #[inline(always)]
    pub fn is_option_byte_error(&self) -> bool {
        *self == OPTERR_A::OPTION_BYTE_ERROR
    }
}
#[doc = "Field `RDPRT` reader - Read protection Level status"]
pub type RDPRT_R = crate::FieldReader<RDPRT_A>;
...
impl crate::FieldSpec for RDPRT_A {
    type Ux = u8;
}
impl RDPRT_R {
    #[doc = "Get enumerated values variant"]
