...
pub type PGERR_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, PGERRW_AW>;
...
pub type WRPRTERR_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, WRPRTERRW_AW>;
...
pub type EOP_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, EOPW_AW>;
