...
pub type TSCE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type AM_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type PGPSC_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 3, O>;
...
pub type SSD_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 7, O>;
...
pub type CTPL_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 4, O>;
...
pub type CTPH_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 4, O>;
impl R {
