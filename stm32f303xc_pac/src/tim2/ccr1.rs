...
pub type CCR1L_R = crate::FieldReader<u16>;
#[doc = "Field `CCR1L` writer - Low Capture/Compare 1 value"]
pub type CCR1L_W<'a, const O: u8> = crate::FieldWriter<'a, CCR1_SPEC, 16, O, u16>;
#[doc = "Field `CCR1H` reader - High Capture/Compare 1 value (on TIM2)"]
pub type CCR1H_R = crate::FieldReader<u16>;
#[doc = "Field `CCR1H` writer - High Capture/Compare 1 value (on TIM2)"]
pub type CCR1H_W<'a, const O: u8> = crate::FieldWriter<'a, CCR1_SPEC, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr1l(&mut self) -> CCR1L_W<0> {
        CCR1L_W::new(self)
    }
    #[doc = "Bits 16:31 - High Capture/Compare 1 value (on TIM2)"]
    #[inline(always)]
    #[must_use]
    pub fn ccr1h(&mut self) -> CCR1H_W<16> {
        CCR1H_W::new(self)
    }
