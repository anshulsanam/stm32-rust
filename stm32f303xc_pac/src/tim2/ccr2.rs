...
pub type CCR2L_R = crate::FieldReader<u16>;
#[doc = "Field `CCR2L` writer - Low Capture/Compare 2 value"]
pub type CCR2L_W<'a, const O: u8> = crate::FieldWriter<'a, CCR2_SPEC, 16, O, u16>;
#[doc = "Field `CCR2H` reader - High Capture/Compare 2 value (on TIM2)"]
pub type CCR2H_R = crate::FieldReader<u16>;
#[doc = "Field `CCR2H` writer - High Capture/Compare 2 value (on TIM2)"]
pub type CCR2H_W<'a, const O: u8> = crate::FieldWriter<'a, CCR2_SPEC, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr2l(&mut self) -> CCR2L_W<0> {
        CCR2L_W::new(self)
    }
    #[doc = "Bits 16:31 - High Capture/Compare 2 value (on TIM2)"]
    #[inline(always)]
    #[must_use]
    pub fn ccr2h(&mut self) -> CCR2H_W<16> {
        CCR2H_W::new(self)
    }
