...
pub type CCR3L_R = crate::FieldReader<u16>;
#[doc = "Field `CCR3L` writer - Low Capture/Compare value"]
pub type CCR3L_W<'a, const O: u8> = crate::FieldWriter<'a, CCR3_SPEC, 16, O, u16>;
#[doc = "Field `CCR3H` reader - High Capture/Compare value (on TIM2)"]
pub type CCR3H_R = crate::FieldReader<u16>;
#[doc = "Field `CCR3H` writer - High Capture/Compare value (on TIM2)"]
pub type CCR3H_W<'a, const O: u8> = crate::FieldWriter<'a, CCR3_SPEC, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr3l(&mut self) -> CCR3L_W<0> {
        CCR3L_W::new(self)
    }
    #[doc = "Bits 16:31 - High Capture/Compare value (on TIM2)"]
    #[inline(always)]
    #[must_use]
    pub fn ccr3h(&mut self) -> CCR3H_W<16> {
        CCR3H_W::new(self)
    }
