...
pub type UG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O, UG_AW>;
...
pub type CC1G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O, CC1GW_AW>;
...
pub type TG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O, TGW_AW>;
