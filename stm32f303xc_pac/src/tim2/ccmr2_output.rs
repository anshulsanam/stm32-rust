...
pub type CC3S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_OUTPUT_SPEC, 2, O, CC3S_A>;
...
pub type OC3PE_W<'a, const O: u8> = crate::BitWriter<'a, CCMR2_OUTPUT_SPEC, O, OC3PE_A>;
...
impl OC3M_R {
    ...
    pub fn variant(&self) -> OC3M_A {
        match self.bits {
            0 => OC3M_A::FROZEN,
            1 => OC3M_A::ACTIVE_ON_MATCH,
            2 => OC3M_A::INACTIVE_ON_MATCH,
            3 => OC3M_A::TOGGLE,
            4 => OC3M_A::FORCE_INACTIVE,
            5 => OC3M_A::FORCE_ACTIVE,
            6 => OC3M_A::PWM_MODE1,
            7 => OC3M_A::PWM_MODE2,
            _ => unreachable!(),
        }
...
impl<'a, const O: u8> OC3M_W<'a, O> {
    ...
    pub fn active_on_match(self) -> &'a mut W {
        self.variant(OC3M_A::ACTIVE_ON_MATCH)
    }
    ...
    pub fn inactive_on_match(self) -> &'a mut W {
        self.variant(OC3M_A::INACTIVE_ON_MATCH)
    }
    ...
    pub fn force_inactive(self) -> &'a mut W {
        self.variant(OC3M_A::FORCE_INACTIVE)
    }
    ...
    pub fn force_active(self) -> &'a mut W {
        self.variant(OC3M_A::FORCE_ACTIVE)
    }
...
pub type CC4S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_OUTPUT_SPEC, 2, O, CC4S_A>;
...
pub type OC4PE_W<'a, const O: u8> = crate::BitWriter<'a, CCMR2_OUTPUT_SPEC, O, OC4PE_A>;
...
pub type OC3M_3_W<'a, const O: u8> = crate::BitWriter<'a, CCMR2_OUTPUT_SPEC, O, OC3M_3_A>;
