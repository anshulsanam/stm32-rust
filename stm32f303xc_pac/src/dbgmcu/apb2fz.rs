...
pub type DBG_TIM15_STOP_W<'a, const O: u8> = crate::BitWriter<'a, APB2FZ_SPEC, O>;
...
pub type DBG_TIM16_STOP_W<'a, const O: u8> = crate::BitWriter<'a, APB2FZ_SPEC, O>;
...
pub type DBG_TIM17_STO_W<'a, const O: u8> = crate::BitWriter<'a, APB2FZ_SPEC, O>;
...
pub type DBG_TIM19_STOP_W<'a, const O: u8> = crate::BitWriter<'a, APB2FZ_SPEC, O>;
impl R {
