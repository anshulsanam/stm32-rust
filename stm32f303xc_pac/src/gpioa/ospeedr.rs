...
pub type OSPEEDR0_R = crate::FieldReader<OSPEEDR0_A>;
...
impl crate::FieldSpec for OSPEEDR0_A {
    type Ux = u8;
}
impl OSPEEDR0_R {
    ...
    pub fn variant(&self) -> Option<OSPEEDR0_A> {
        match self.bits {
            0 => Some(OSPEEDR0_A::LOW_SPEED),
            1 => Some(OSPEEDR0_A::MEDIUM_SPEED),
            3 => Some(OSPEEDR0_A::HIGH_SPEED),
            _ => None,
        }
    }
