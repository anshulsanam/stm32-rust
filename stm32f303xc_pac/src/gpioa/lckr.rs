...
pub type LCK0_W<'a, const O: u8> = crate::BitWriter<'a, LCKR_SPEC, O, LCK0_A>;
...
pub type LCK10_W<'a, const O: u8> = crate::BitWriter<'a, LCKR_SPEC, O, LCK10_A>;
impl<'a, const O: u8> LCK10_W<'a, O> {
    #[doc = "Port configuration not locked"]
    #[inline(always)]
    pub fn unlocked(self) -> &'a mut W {
