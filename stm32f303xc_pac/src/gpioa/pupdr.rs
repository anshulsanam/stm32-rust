...
impl PUPDR0_R {
    ...
    pub fn variant(&self) -> Option<PUPDR0_A> {
        match self.bits {
            ...
            1 => Some(PUPDR0_A::PULL_UP),
            2 => Some(PUPDR0_A::PULL_DOWN),
            _ => None,
        }
    }
    ...
    pub fn is_pull_up(&self) -> bool {
        *self == PUPDR0_A::PULL_UP
    }
    #[doc = "Checks if the value of the field is `PULL_DOWN`"]
    #[inline(always)]
    pub fn is_pull_down(&self) -> bool {
        *self == PUPDR0_A::PULL_DOWN
    }
}
#[doc = "Field `PUPDR0` writer - Port x configuration bits (y = 0..15)"]
pub type PUPDR0_W<'a, const O: u8> = crate::FieldWriter<'a, PUPDR_SPEC, 2, O, PUPDR0_A>;
impl<'a, const O: u8> PUPDR0_W<'a, O> {
    ...
    pub fn pull_up(self) -> &'a mut W {
        self.variant(PUPDR0_A::PULL_UP)
    }
    #[doc = "Pull-down"]
    #[inline(always)]
    pub fn pull_down(self) -> &'a mut W {
        self.variant(PUPDR0_A::PULL_DOWN)
    }
}
