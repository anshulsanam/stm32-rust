...
pub type IOC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type DZC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type OFC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type UFC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type IXC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type IDC_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type RMODE_W<'a, const O: u8> = crate::FieldWriter<'a, FPSCR_SPEC, 2, O>;
...
pub type FZ_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type DN_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type AHP_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
...
pub type N_W<'a, const O: u8> = crate::BitWriter<'a, FPSCR_SPEC, O>;
impl R {
