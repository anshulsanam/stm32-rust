...
impl OSSI_R {
    ...
    #[doc = "Checks if the value of the field is `IDLE_LEVEL`"]
    #[inline(always)]
    pub fn is_idle_level(&self) -> bool {
        *self == OSSI_A::IDLE_LEVEL
    }
}
#[doc = "Field `OSSI` writer - Off-state selection for Idle mode"]
pub type OSSI_W<'a, const O: u8> = crate::BitWriter<'a, BDTR_SPEC, O, OSSI_A>;
impl<'a, const O: u8> OSSI_W<'a, O> {
    ...
    pub fn idle_level(self) -> &'a mut W {
        self.variant(OSSI_A::IDLE_LEVEL)
    }
}
...
impl OSSR_R {
    ...
    #[inline(always)]
    pub fn is_idle_level(&self) -> bool {
        *self == OSSR_A::IDLE_LEVEL
    }
}
#[doc = "Field `OSSR` writer - Off-state selection for Run mode"]
pub type OSSR_W<'a, const O: u8> = crate::BitWriter<'a, BDTR_SPEC, O, OSSR_A>;
impl<'a, const O: u8> OSSR_W<'a, O> {
    ...
    #[inline(always)]
    pub fn idle_level(self) -> &'a mut W {
        self.variant(OSSR_A::IDLE_LEVEL)
    }
}
...
impl MOE_R {
    ...
    pub fn variant(&self) -> MOE_A {
        match self.bits {
            false => MOE_A::DISABLED_IDLE,
            true => MOE_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED_IDLE`"]
    #[inline(always)]
    pub fn is_disabled_idle(&self) -> bool {
        *self == MOE_A::DISABLED_IDLE
    }
