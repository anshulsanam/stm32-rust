...
pub type TIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O, TIE_A>;
...
pub type UDE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O, UDE_A>;
...
pub type TDE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O, TDE_A>;
