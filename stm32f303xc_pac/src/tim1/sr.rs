...
impl UIF_R {
    ...
    #[doc = "Checks if the value of the field is `UPDATE_PENDING`"]
    #[inline(always)]
    pub fn is_update_pending(&self) -> bool {
        *self == UIF_A::UPDATE_PENDING
    }
}
#[doc = "Field `UIF` writer - Update interrupt flag"]
pub type UIF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, UIF_A>;
impl<'a, const O: u8> UIF_W<'a, O> {
    ...
    pub fn update_pending(self) -> &'a mut W {
        self.variant(UIF_A::UPDATE_PENDING)
    }
}
...
pub type CC1IF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, CC1IFW_AW>;
...
pub type TIF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, TIFW_AW>;
...
pub type CC1OF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, CC1OFW_AW>;
...
pub type C5IF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O>;
...
pub type C6IF_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O>;
impl R {
