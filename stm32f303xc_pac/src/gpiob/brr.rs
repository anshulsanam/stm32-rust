...
impl From<BR10W_AW> for bool {
    #[inline(always)]
    fn from(variant: BR10W_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `BR10` writer - Port x Reset bit y"]
pub type BR10_W<'a, const O: u8> = crate::BitWriter<'a, BRR_SPEC, O, BR10W_AW>;
impl<'a, const O: u8> BR10_W<'a, O> {
    #[doc = "No action on the corresponding ODx bit"]
    #[inline(always)]
    pub fn no_action(self) -> &'a mut W {
        self.variant(BR10W_AW::NO_ACTION)
    }
    #[doc = "Reset the ODx bit"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(BR10W_AW::RESET)
    }
}
#[doc = "Field `BR11` writer - Port x Reset bit y"]
pub use BR10_W as BR11_W;
#[doc = "Field `BR12` writer - Port x Reset bit y"]
pub use BR10_W as BR12_W;
#[doc = "Field `BR13` writer - Port x Reset bit y"]
pub use BR10_W as BR13_W;
#[doc = "Field `BR14` writer - Port x Reset bit y"]
pub use BR10_W as BR14_W;
#[doc = "Field `BR15` writer - Port x Reset bit y"]
pub use BR10_W as BR15_W;
impl W {
