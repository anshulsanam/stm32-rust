...
impl AWD2CH0_R {
    ...
    pub fn variant(&self) -> AWD2CH0_A {
        match self.bits {
            false => AWD2CH0_A::NOT_MONITORED,
            true => AWD2CH0_A::MONITORED,
        }
    }
    #[doc = "Checks if the value of the field is `NOT_MONITORED`"]
    #[inline(always)]
    pub fn is_not_monitored(&self) -> bool {
        *self == AWD2CH0_A::NOT_MONITORED
    }
...
pub type AWD2CH0_W<'a, const O: u8> = crate::BitWriter<'a, AWD2CR_SPEC, O, AWD2CH0_A>;
impl<'a, const O: u8> AWD2CH0_W<'a, O> {
    #[doc = "Input channel not monitored by AWDx"]
    #[inline(always)]
    pub fn not_monitored(self) -> &'a mut W {
        self.variant(AWD2CH0_A::NOT_MONITORED)
    }
