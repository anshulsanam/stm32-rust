...
pub type AWD3CH0_W<'a, const O: u8> = crate::BitWriter<'a, AWD3CR_SPEC, O, AWD3CH0_A>;
impl<'a, const O: u8> AWD3CH0_W<'a, O> {
    #[doc = "Input channel not monitored by AWDx"]
    #[inline(always)]
    pub fn not_monitored(self) -> &'a mut W {
        self.variant(AWD3CH0_A::NOT_MONITORED)
    }
