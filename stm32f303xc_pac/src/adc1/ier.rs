...
pub type ADRDYIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, ADRDYIE_A>;
...
pub type EOSMPIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EOSMPIE_A>;
...
pub type EOCIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EOCIE_A>;
...
pub type EOSIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EOSIE_A>;
...
pub type OVRIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, OVRIE_A>;
...
pub type JEOCIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, JEOCIE_A>;
...
pub type JEOSIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, JEOSIE_A>;
...
pub type AWD1IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, AWD1IE_A>;
...
pub type JQOVFIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, JQOVFIE_A>;
