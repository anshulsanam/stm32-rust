...
pub type DMAUDR1_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O, DMAUDR1_A>;
impl<'a, const O: u8> DMAUDR1_W<'a, O> {
    ...
    pub fn no_underrun(self) -> &'a mut W {
        self.variant(DMAUDR1_A::NO_UNDERRUN)
    }
