...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DHR12LD_SPEC, 12, O, u16>;
...
pub type DACC2DHR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DHR12LD_SPEC, 12, O, u16>;
impl R {
