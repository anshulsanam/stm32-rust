...
pub type EN1_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type BOFF1_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TEN1_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 3, O>;
...
pub type WAVE1_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 2, O>;
...
pub type MAMP1_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 4, O>;
...
pub type DMAEN1_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type DMAUDRIE1_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `EN2` reader - DAC channel2 enable"]
pub type EN2_R = crate::BitReader;
#[doc = "Field `EN2` writer - DAC channel2 enable"]
pub type EN2_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type BOFF2_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TEN2_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 3, O>;
...
pub type WAVE2_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 2, O>;
...
pub type MAMP2_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 4, O>;
...
pub type DMAEN2_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type DMAUDRIE2_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
impl R {
