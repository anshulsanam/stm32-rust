...
pub type COMP5EN_W<'a, const O: u8> = crate::BitWriter<'a, COMP5_CSR_SPEC, O>;
...
pub type COMP5MODE_W<'a, const O: u8> = crate::FieldWriter<'a, COMP5_CSR_SPEC, 2, O>;
#[doc = "Field `COMP5INSEL` reader - Comparator 5 inverting input selection"]
pub type COMP5INSEL_R = crate::FieldReader;
#[doc = "Field `COMP5INSEL` writer - Comparator 5 inverting input selection"]
pub type COMP5INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP5_CSR_SPEC, 3, O>;
...
pub type COMP5INPSEL_W<'a, const O: u8> = crate::BitWriter<'a, COMP5_CSR_SPEC, O>;
#[doc = "Field `COMP5_OUT_SEL` reader - Comparator 5 output selection"]
pub type COMP5_OUT_SEL_R = crate::FieldReader;
#[doc = "Field `COMP5_OUT_SEL` writer - Comparator 5 output selection"]
pub type COMP5_OUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP5_CSR_SPEC, 4, O>;
...
pub type COMP5POL_W<'a, const O: u8> = crate::BitWriter<'a, COMP5_CSR_SPEC, O>;
...
pub type COMP5HYST_W<'a, const O: u8> = crate::FieldWriter<'a, COMP5_CSR_SPEC, 2, O>;
...
pub type COMP5_BLANKING_W<'a, const O: u8> = crate::FieldWriter<'a, COMP5_CSR_SPEC, 3, O>;
...
pub type COMP5LOCK_W<'a, const O: u8> = crate::BitWriter<'a, COMP5_CSR_SPEC, O>;
impl R {
    ...
    pub fn comp5insel(&self) -> COMP5INSEL_R {
        COMP5INSEL_R::new(((self.bits >> 4) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp5insel(&mut self) -> COMP5INSEL_W<4> {
        COMP5INSEL_W::new(self)
    }
    #[doc = "Bit 7 - Comparator 5 non inverted input selection"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp5_out_sel(&mut self) -> COMP5_OUT_SEL_W<10> {
        COMP5_OUT_SEL_W::new(self)
    }
    #[doc = "Bit 15 - Comparator 5 output polarity"]
    #[inline(always)]
    #[must_use]
