...
pub type COMP3EN_W<'a, const O: u8> = crate::BitWriter<'a, COMP3_CSR_SPEC, O>;
...
pub type COMP3MODE_W<'a, const O: u8> = crate::FieldWriter<'a, COMP3_CSR_SPEC, 2, O>;
#[doc = "Field `COMP3INSEL` reader - Comparator 3 inverting input selection"]
pub type COMP3INSEL_R = crate::FieldReader;
#[doc = "Field `COMP3INSEL` writer - Comparator 3 inverting input selection"]
pub type COMP3INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP3_CSR_SPEC, 3, O>;
...
pub type COMP3INPSEL_W<'a, const O: u8> = crate::BitWriter<'a, COMP3_CSR_SPEC, O>;
#[doc = "Field `COMP3_OUT_SEL` reader - Comparator 3 output selection"]
pub type COMP3_OUT_SEL_R = crate::FieldReader;
#[doc = "Field `COMP3_OUT_SEL` writer - Comparator 3 output selection"]
pub type COMP3_OUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP3_CSR_SPEC, 4, O>;
...
pub type COMP3POL_W<'a, const O: u8> = crate::BitWriter<'a, COMP3_CSR_SPEC, O>;
...
pub type COMP3HYST_W<'a, const O: u8> = crate::FieldWriter<'a, COMP3_CSR_SPEC, 2, O>;
...
pub type COMP3_BLANKING_W<'a, const O: u8> = crate::FieldWriter<'a, COMP3_CSR_SPEC, 3, O>;
...
pub type COMP3LOCK_W<'a, const O: u8> = crate::BitWriter<'a, COMP3_CSR_SPEC, O>;
impl R {
    ...
    pub fn comp3insel(&self) -> COMP3INSEL_R {
        COMP3INSEL_R::new(((self.bits >> 4) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp3insel(&mut self) -> COMP3INSEL_W<4> {
        COMP3INSEL_W::new(self)
    }
    #[doc = "Bit 7 - Comparator 3 non inverted input selection"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp3_out_sel(&mut self) -> COMP3_OUT_SEL_W<10> {
        COMP3_OUT_SEL_W::new(self)
    }
    #[doc = "Bit 15 - Comparator 3 output polarity"]
    #[inline(always)]
    #[must_use]
