...
pub type COMP1EN_W<'a, const O: u8> = crate::BitWriter<'a, COMP1_CSR_SPEC, O>;
...
pub type COMP1_INP_DAC_W<'a, const O: u8> = crate::BitWriter<'a, COMP1_CSR_SPEC, O>;
...
pub type COMP1MODE_W<'a, const O: u8> = crate::FieldWriter<'a, COMP1_CSR_SPEC, 2, O>;
...
pub type COMP1INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP1_CSR_SPEC, 3, O>;
#[doc = "Field `COMP1_OUT_SEL` reader - Comparator 1 output selection"]
pub type COMP1_OUT_SEL_R = crate::FieldReader;
#[doc = "Field `COMP1_OUT_SEL` writer - Comparator 1 output selection"]
pub type COMP1_OUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP1_CSR_SPEC, 4, O>;
...
pub type COMP1POL_W<'a, const O: u8> = crate::BitWriter<'a, COMP1_CSR_SPEC, O>;
...
pub type COMP1HYST_W<'a, const O: u8> = crate::FieldWriter<'a, COMP1_CSR_SPEC, 2, O>;
...
pub type COMP1_BLANKING_W<'a, const O: u8> = crate::FieldWriter<'a, COMP1_CSR_SPEC, 3, O>;
...
pub type COMP1LOCK_W<'a, const O: u8> = crate::BitWriter<'a, COMP1_CSR_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp1_out_sel(&mut self) -> COMP1_OUT_SEL_W<10> {
        COMP1_OUT_SEL_W::new(self)
    }
    #[doc = "Bit 15 - Comparator 1 output polarity"]
    #[inline(always)]
    #[must_use]
