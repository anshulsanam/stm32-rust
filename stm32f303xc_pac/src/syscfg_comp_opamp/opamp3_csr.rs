...
pub type OPAMP3EN_R = crate::BitReader;
#[doc = "Field `OPAMP3EN` writer - OPAMP3 enable"]
pub type OPAMP3EN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP3_CSR_SPEC, O>;
...
pub type TCM_EN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP3_CSR_SPEC, O>;
...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP3_CSR_SPEC, O>;
...
pub type VPS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP3_CSR_SPEC, 2, O>;
...
pub type PGA_GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP3_CSR_SPEC, 4, O>;
...
pub type USER_TRIM_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP3_CSR_SPEC, O>;
...
pub type TSTREF_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP3_CSR_SPEC, O>;
