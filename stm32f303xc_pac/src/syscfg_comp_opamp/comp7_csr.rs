...
pub type COMP7EN_W<'a, const O: u8> = crate::BitWriter<'a, COMP7_CSR_SPEC, O>;
...
pub type COMP7MODE_W<'a, const O: u8> = crate::FieldWriter<'a, COMP7_CSR_SPEC, 2, O>;
#[doc = "Field `COMP7INSEL` reader - Comparator 7 inverting input selection"]
pub type COMP7INSEL_R = crate::FieldReader;
#[doc = "Field `COMP7INSEL` writer - Comparator 7 inverting input selection"]
pub type COMP7INSEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP7_CSR_SPEC, 3, O>;
...
pub type COMP7INPSEL_W<'a, const O: u8> = crate::BitWriter<'a, COMP7_CSR_SPEC, O>;
#[doc = "Field `COMP7_OUT_SEL` reader - Comparator 7 output selection"]
pub type COMP7_OUT_SEL_R = crate::FieldReader;
#[doc = "Field `COMP7_OUT_SEL` writer - Comparator 7 output selection"]
pub type COMP7_OUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, COMP7_CSR_SPEC, 4, O>;
...
pub type COMP7POL_W<'a, const O: u8> = crate::BitWriter<'a, COMP7_CSR_SPEC, O>;
...
pub type COMP7HYST_W<'a, const O: u8> = crate::FieldWriter<'a, COMP7_CSR_SPEC, 2, O>;
...
pub type COMP7_BLANKING_W<'a, const O: u8> = crate::FieldWriter<'a, COMP7_CSR_SPEC, 3, O>;
...
pub type COMP7LOCK_W<'a, const O: u8> = crate::BitWriter<'a, COMP7_CSR_SPEC, O>;
impl R {
    ...
    pub fn comp7insel(&self) -> COMP7INSEL_R {
        COMP7INSEL_R::new(((self.bits >> 4) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp7insel(&mut self) -> COMP7INSEL_W<4> {
        COMP7INSEL_W::new(self)
    }
    #[doc = "Bit 7 - Comparator 7 non inverted input selection"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp7_out_sel(&mut self) -> COMP7_OUT_SEL_W<10> {
        COMP7_OUT_SEL_W::new(self)
    }
    #[doc = "Bit 15 - Comparator 7 output polarity"]
    #[inline(always)]
    #[must_use]
