...
pub type OPAMP1_EN_R = crate::BitReader;
#[doc = "Field `OPAMP1_EN` writer - OPAMP1 enable"]
pub type OPAMP1_EN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP1_CSR_SPEC, O>;
...
pub type TCM_EN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP1_CSR_SPEC, O>;
...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP1_CSR_SPEC, O>;
...
pub type VPS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP1_CSR_SPEC, 2, O>;
...
pub type PGA_GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP1_CSR_SPEC, 4, O>;
...
pub type USER_TRIM_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP1_CSR_SPEC, O>;
...
pub type TSTREF_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP1_CSR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opamp1_en(&mut self) -> OPAMP1_EN_W<0> {
        OPAMP1_EN_W::new(self)
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline(always)]
    #[must_use]
