...
pub type COMP4EN_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O, COMP4EN_A>;
...
pub type COMP4MODE_W<'a, const O: u8> = crate::FieldWriter<'a, COMP4_CSR_SPEC, 2, O>;
...
impl COMP4INMSEL_R {
    ...
    pub fn variant(&self) -> Option<COMP4INMSEL_A> {
        match self.bits {
            0 => Some(COMP4INMSEL_A::ONE_QUARTER_VREF),
            1 => Some(COMP4INMSEL_A::ONE_HALF_VREF),
            2 => Some(COMP4INMSEL_A::THREE_QUARTER_VREF),
...
pub type COMP4INMSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, COMP4_CSR_SPEC, 3, O, COMP4INMSEL_A>;
impl<'a, const O: u8> COMP4INMSEL_W<'a, O> {
    #[doc = "1/4 of VRefint"]
    #[inline(always)]
    pub fn one_quarter_vref(self) -> &'a mut W {
        self.variant(COMP4INMSEL_A::ONE_QUARTER_VREF)
    }
    #[doc = "1/2 of VRefint"]
    #[inline(always)]
    pub fn one_half_vref(self) -> &'a mut W {
        self.variant(COMP4INMSEL_A::ONE_HALF_VREF)
    }
    #[doc = "3/4 of VRefint"]
    #[inline(always)]
    pub fn three_quarter_vref(self) -> &'a mut W {
        self.variant(COMP4INMSEL_A::THREE_QUARTER_VREF)
    }
    #[doc = "VRefint"]
    #[inline(always)]
...
pub type COMP4INPSEL_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O>;
...
pub type COMP4WINMODE_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O>;
...
pub enum COMP4OUTSEL_A {
    ...
    TIMER3INPUT_CAPTURE3 = 6,
    #[doc = "8: Timer 15 input capture 2"]
    TIMER15INPUT_CAPTURE2 = 8,
    #[doc = "10: Timer 15 OCREF_CLR input"]
    TIMER15OCREF_CLEAR_INPUT = 10,
...
impl COMP4OUTSEL_R {
    ...
    pub fn variant(&self) -> Option<COMP4OUTSEL_A> {
        match self.bits {
            0 => Some(COMP4OUTSEL_A::NO_SELECTION),
            1 => Some(COMP4OUTSEL_A::TIMER1BREAK_INPUT),
            2 => Some(COMP4OUTSEL_A::TIMER1BREAK_INPUT2),
            6 => Some(COMP4OUTSEL_A::TIMER3INPUT_CAPTURE3),
            8 => Some(COMP4OUTSEL_A::TIMER15INPUT_CAPTURE2),
            10 => Some(COMP4OUTSEL_A::TIMER15OCREF_CLEAR_INPUT),
            11 => Some(COMP4OUTSEL_A::TIMER3OCREF_CLEAR_INPUT),
            _ => None,
        }
    }
...
pub type COMP4POL_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O, COMP4POL_A>;
impl<'a, const O: u8> COMP4POL_W<'a, O> {
    #[doc = "Output is not inverted"]
    #[inline(always)]
    pub fn not_inverted(self) -> &'a mut W {
        self.variant(COMP4POL_A::NOT_INVERTED)
    }
...
pub type COMP4HYST_W<'a, const O: u8> = crate::FieldWriter<'a, COMP4_CSR_SPEC, 2, O>;
...
impl COMP4_BLANKING_R {
    ...
    pub fn variant(&self) -> Option<COMP4_BLANKING_A> {
        match self.bits {
            0 => Some(COMP4_BLANKING_A::NO_BLANKING),
    ...
    pub fn is_no_blanking(&self) -> bool {
        *self == COMP4_BLANKING_A::NO_BLANKING
    }
...
pub type COMP4_BLANKING_W<'a, const O: u8> =
    crate::FieldWriter<'a, COMP4_CSR_SPEC, 3, O, COMP4_BLANKING_A>;
impl<'a, const O: u8> COMP4_BLANKING_W<'a, O> {
    #[doc = "No blanking"]
    #[inline(always)]
    pub fn no_blanking(self) -> &'a mut W {
        self.variant(COMP4_BLANKING_A::NO_BLANKING)
    }
...
pub type COMP4INMSEL3_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O>;
...
pub type COMP4LOCK_W<'a, const O: u8> = crate::BitWriter<'a, COMP4_CSR_SPEC, O, COMP4LOCK_A>;
